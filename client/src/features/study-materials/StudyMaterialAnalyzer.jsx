              ...
              <div className="p-4 rounded-2xl bg-rose-500/10 border border-rose-500/30 text-rose-300 text-xs flex items-start justify-between gap-3">
                ...
                {selectedFile && (
                  <button
                    ...
                    disabled={loading}
                    className="shrink-0 px-2.5 py-1 rounded-lg bg-rose-500/20 hover:bg-rose-500/30 text-rose-200 font-bold text-[11px] transition-all"
                  >
                    Retry
                  </button>
                )}
                    ...
                    {analysisResult.commonMistakes.map((m, idx) => (
                      ...
                      >
                        ...
                        {typeof m !== 'string' && m.explanation && (
                          <p className="text-slate-400 text-[11px] pl-4">{m.explanation}</p>
                        )}
                      </div>
                    ))}
                  </div>
