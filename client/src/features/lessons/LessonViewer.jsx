  ...
  if (!course || !course.modules || course.modules.length === 0) {
    return (
      <div className="rounded-3xl p-10 bg-[#0d1322] border border-white/10 text-center max-w-xl mx-auto my-8">
        ...
        <button
          onClick={onBack}
          className="mt-6 px-6 py-2.5 rounded-xl bg-indigo-600 hover:bg-indigo-500 text-white text-xs font-bold min-h-[40px]"
        >
  ...
  return (
    <div className="max-w-7xl mx-auto space-y-6">
      ...
      <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4">
        <div>
          <div className="flex flex-wrap items-center gap-1.5 text-xs text-indigo-400 font-semibold mb-1 cursor-pointer" onClick={onBack}>
            ...
            <div className="rounded-3xl p-5 sm:p-8 bg-[#0d1322] border border-white/10 shadow-2xl space-y-6">
              ...
              {loading ? (
                <div className="py-16 text-center space-y-3">
                  ...
                  <p className="text-xs text-slate-300 font-bold">Generating Structured Lesson Material...</p>
                </div>
              ) : error && !lessonData ? (
                <div className="py-16 text-center space-y-4">
                  <div className="p-4 bg-red-500/10 border border-red-500/20 rounded-2xl max-w-md mx-auto text-red-300 text-xs">
                    {error}
                  </div>
                  <button
                    onClick={fetchLesson}
                    className="px-5 py-2.5 rounded-xl bg-indigo-600 hover:bg-indigo-500 text-white text-xs font-bold transition-all shadow-md min-h-[40px]"
                  >
              ...
              <div className="flex flex-wrap items-center justify-between gap-3 pt-6 border-t border-white/5">
                <button
                  ...
                  className="px-4 py-2.5 rounded-xl bg-white/5 hover:bg-white/10 disabled:opacity-30 border border-white/10 text-xs font-bold text-slate-300 transition-all flex items-center space-x-2 min-h-[44px]"
                >
                ...
                <button
                  ...
                  className={`px-4 py-2.5 rounded-xl text-xs font-bold transition-all flex items-center space-x-2 border min-h-[44px] ${
                    isLessonCompleted
                ...
                <button
                  ...
                  className="px-5 py-2.5 rounded-xl bg-gradient-to-r from-indigo-600 to-purple-600 hover:from-indigo-500 hover:to-purple-500 text-xs font-bold text-white shadow-lg shadow-indigo-600/25 transition-all flex items-center space-x-2 min-h-[44px]"
                >
            ...
            <div className="rounded-3xl bg-[#0d1322] border border-white/10 shadow-2xl flex flex-col h-[580px] overflow-hidden">
              ...
              <div className="p-4 border-b border-white/5 flex items-center justify-between bg-[#0b0f19]">
                <div className="flex items-center space-x-2.5 min-w-0">
                  ...
                  <div className="min-w-0">
                    <h3 className="text-xs font-bold text-white truncate">PadhAI Tutor</h3>
                ...
                <div className="flex items-center space-x-1.5 px-2.5 py-1 rounded-full bg-emerald-500/10 border border-emerald-500/20 text-emerald-400 text-[10px] font-bold shrink-0">
              ...
              >
                <input
                  ...
                  className="flex-1 bg-[#080c14] border border-white/10 rounded-xl px-3.5 py-2.5 text-xs text-white placeholder-slate-400 focus:outline-none focus:border-indigo-500 transition-colors min-h-[40px]"
                />
                <button
                  type="submit"
