              ...
              return (
                ...
                >
                  <div className="flex items-start justify-between gap-3">
                    ...
                    <span
                      className={`shrink-0 flex items-center space-x-1 px-2.5 py-1 rounded-xl text-[10px] font-bold uppercase ${
                        isQCorrect
      ...
      <div className="rounded-3xl p-6 sm:p-10 bg-[#0d1322] border border-white/10 shadow-2xl space-y-6">
        ...
        <div className="space-y-2">
          {currentQ.relatedConcept && (
            <span className="inline-block px-2.5 py-0.5 rounded-full bg-indigo-500/10 border border-indigo-500/20 text-indigo-300 text-[10px] font-bold uppercase tracking-wider">
              {currentQ.relatedConcept}
            </span>
          )}
