  ...
  if (!course) {
    return (
      <div className="rounded-3xl p-8 sm:p-12 bg-[#0d1322] border border-white/10 text-center max-w-2xl mx-auto my-8 sm:my-12">
        ...
        <p className="text-sm text-slate-400 mb-6">Create a personalized course outline to unlock your full learning roadmap.</p>
        <button
          onClick={onEditPlan}
          className="px-6 py-3 rounded-xl bg-gradient-to-r from-indigo-600 to-purple-600 hover:from-indigo-500 hover:to-purple-500 text-white text-sm font-bold transition-all shadow-lg shadow-indigo-600/30 min-h-[44px]"
        >
      ...
      <div className="rounded-3xl p-5 sm:p-8 bg-[#0d1322] border border-white/10 shadow-2xl space-y-6">
        <div className="space-y-4">
          <div className="flex flex-col md:flex-row md:items-center justify-between gap-4">
            ...
            <button
              onClick={onEditPlan}
              className="px-4 py-2 rounded-xl bg-white/5 hover:bg-white/10 border border-white/10 text-sm font-bold text-slate-300 hover:text-white transition-all flex items-center space-x-1.5 min-h-[36px]"
            >
        ...
        <div className="flex flex-wrap items-center gap-1.5 sm:gap-2 border-b border-white/5 pb-2">
          <button
            ...
            className={`px-3.5 py-2 rounded-xl text-sm font-bold transition-all flex items-center space-x-1.5 min-h-[36px] ${
              activeTab === 'days'
                          ...
                          >
                            <div className="flex items-center space-x-3 min-w-0 pr-2">
                              ...
                              <div className="min-w-0">
                                <span className="text-sm font-semibold truncate block">{lesson.title}</span>
                                {lesson.learningObjective && (
                                  <span className="text-sm text-slate-400 truncate block">{lesson.learningObjective}</span>
                                )}
                              </div>
                            </div>
                ...
                >
                  <div className="flex items-center space-x-3.5 min-w-0 pr-2">
                    ...
                    <div className="min-w-0">
                      ...
                      {module.description && (
                        <p className="text-sm text-slate-400 truncate mt-0.5">{module.description}</p>
                      )}
                    </div>
                  </div>
                        ...
                        return (
                          ...
                          >
                            <div className="flex items-center space-x-3 min-w-0 pr-2">
                              ...
                              <div className="min-w-0">
                                <span className="text-sm font-semibold block truncate">{lesson.title}</span>
                                {lesson.learningObjective && (
                                  <span className="text-sm text-slate-400 block truncate">{lesson.learningObjective}</span>
                                )}
                              </div>
                            </div>
