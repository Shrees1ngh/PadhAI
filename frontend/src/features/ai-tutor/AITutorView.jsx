      ...
      <div className="flex items-center gap-2 overflow-x-auto pb-1 shrink-0">
        {QUICK_QUESTIONS.map((q, i) => (
          <button
            ...
            className="px-3 py-1.5 rounded-xl bg-white/5 hover:bg-white/10 border border-white/10 text-xs font-semibold text-slate-300 hover:text-white shrink-0 transition-all flex items-center space-x-1.5 disabled:opacity-50"
          >
