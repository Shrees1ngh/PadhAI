        ...
        <div className="flex items-center space-x-3">
          ...
          <div>
            <div className="flex items-center space-x-2">
              ...
              <span className="hidden sm:inline-flex px-2 py-0.5 rounded-full bg-rose-500/10 border border-rose-500/20 text-rose-300 text-xs font-mono">
                YouTube v3
              </span>
            </div>
          ...
          {videos.map((video, idx) => (
            ...
            >
              ...
              <div className="relative w-full aspect-video bg-slate-950 overflow-hidden">
                ...
                {/* YouTube Badge */}
                <div className="absolute top-2.5 right-2.5 px-2 py-0.5 rounded-md bg-black/70 backdrop-blur-md text-white text-xs font-mono flex items-center space-x-1 border border-white/10">
