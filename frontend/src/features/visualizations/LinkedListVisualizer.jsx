    ...
    <div className="rounded-3xl p-6 bg-[#080c14] border border-white/10 shadow-2xl space-y-6">
            ...
            nodes.map((node, idx) => {
              ...
              return (
                <React.Fragment key={node.id}>
                  ...
                  >
                    {/* Position Label */}
                    <div className="h-4 flex items-center space-x-1 mb-1 text-xs font-mono font-bold">
                    ...
                    <span className="text-xs font-mono text-slate-500 mt-1.5">
                  ...
                  {isTail && (
                    <div className="flex items-center space-x-1 text-rose-400/80 font-mono text-xs px-1">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-3 pt-2">
        <div className="p-3 rounded-2xl bg-white/[0.02] border border-white/5 space-y-2">
          <span className="text-xs font-bold uppercase tracking-wider text-slate-400">Insert Nodes</span>
