    ...
    <div className="rounded-3xl p-6 bg-[#080c14] border border-white/10 shadow-2xl space-y-6">
          ...
          {array.length === 0 ? (
            ...
            array.map((val, idx) => {
              ...
              return (
                ...
                >
                  {/* Index Indicator */}
                  <span className="text-xs font-mono font-bold text-slate-400 mb-1.5 group-hover:text-cyan-400 transition-colors">
                    [{idx}]
                  </span>
                  ...
                  {showMemory && (
                    <span className="text-xs font-mono text-cyan-400/80 mt-1.5 bg-cyan-950/40 px-1.5 py-0.5 rounded border border-cyan-500/20">
                      {memAddr}
                    </span>
                  )}
                </motion.div>
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-3 pt-2">
        ...
        <div className="p-3 rounded-2xl bg-white/[0.02] border border-white/5 space-y-2">
          <span className="text-xs font-bold uppercase tracking-wider text-slate-400">Insert Element</span>
        ...
        <div className="p-3 rounded-2xl bg-white/[0.02] border border-white/5 space-y-2">
          <span className="text-xs font-bold uppercase tracking-wider text-slate-400">Search & Delete</span>
          <div className="flex items-center gap-2">
            <input
              type="number"
