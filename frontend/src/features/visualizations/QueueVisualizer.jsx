    ...
    <div className="rounded-3xl p-6 bg-[#080c14] border border-white/10 shadow-2xl space-y-6">
      ...
      <div className="overflow-x-auto py-8 px-2">
        <div className="flex items-center justify-center min-w-[320px] gap-2 border-y-2 border-blue-500/30 py-6 px-4 bg-[#0d1322]/50 rounded-2xl relative">
          <span className="absolute left-3 top-1 text-xs font-bold text-blue-400 uppercase tracking-wider">
            ← FRONT (Out)
          </span>
          <span className="absolute right-3 top-1 text-xs font-bold text-indigo-400 uppercase tracking-wider">
            REAR (In) ←
          </span>
            ...
            <AnimatePresence>
              {queue.map((val, idx) => {
                ...
                return (
                  ...
                  >
                    <div className="h-4 text-xs font-mono font-bold">
                    ...
                    <span className="text-xs text-slate-500 font-mono mt-1">pos: {idx}</span>
                  </motion.div>
                );
              })}
            </AnimatePresence>
